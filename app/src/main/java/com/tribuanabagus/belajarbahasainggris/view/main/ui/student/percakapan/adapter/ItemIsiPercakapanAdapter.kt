...
import com.tribuanabagus.belajarbahasainggris.databinding.ItemIsiPercakapanBinding
...
class ItemIsiPercakapanAdapter(private val fragmentActivity: FragmentActivity) :
    RecyclerView.Adapter<ItemIsiPercakapanAdapter.ItemIsiPercakapanViewHolder>(),
    TextToSpeech.OnInitListener {

    private var _binding: ItemIsiPercakapanBinding? = null
    ...
    override fun onInit(status: Int) {
        if (status == TextToSpeech.SUCCESS) {
            ...
            if (lang == TextToSpeech.LANG_MISSING_DATA
                ...
                Toast.makeText(fragmentActivity, "Bahasa speech tidak didukung", Toast.LENGTH_SHORT)
                    .show()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): ItemIsiPercakapanViewHolder {
        _binding =
            ItemIsiPercakapanBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ItemIsiPercakapanViewHolder(binding)
    }

    override fun onBindViewHolder(viewHolder: ItemIsiPercakapanViewHolder, position: Int) {
        viewHolder.bind(data[position])
    }

    override fun getItemCount() = data.size

    inner class ItemIsiPercakapanViewHolder(private val binding: ItemIsiPercakapanBinding) :
        ...
        fun bind(data: ResultsSoal) {
            ...
            with(binding) {
                tvEnIsiPercakapan.text = data.title
                tvIdIsiPercakapan.text = data.subtitle
