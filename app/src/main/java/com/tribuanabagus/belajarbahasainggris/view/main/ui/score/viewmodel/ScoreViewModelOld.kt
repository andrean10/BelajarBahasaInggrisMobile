package com.tribuanabagus.belajarbahasainggris.view.main.ui.score.viewmodel
...
class ScoreViewModelOld : ViewModel() {
    ...
    private val TAG = ScoreViewModelOld::class.java.simpleName
